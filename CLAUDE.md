...
- 보상 (9/11): 고정 별 3개 제거. 작품별 최고 완료 조각 수를 bestPieces에 저장. 6/24/48/96조각에서 오크/도자기/월넛/골드 프레임. 낮은 난도로 재완성해도 다운그레이드하지 않는다. 사진 교체 시 이전 사진의 완료·프레임·모든 난도 진행을 초기화한다.
- 상단은 한 줄: 로고 / 아이·어른 토글 / 코인 / 설정. 계정·기록은 설정에 통합. 사진 퍼즐은 두 모드 홈에 직접 노출. 어른은 따뜻한 작업실 테마.
